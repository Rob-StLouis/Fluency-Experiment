		...
		switch (musicCondition) {
			...
			case 1:
				...
				d3.select("#additionaltext").html('<p> In this section, music will be playing in the background. '+
					...
					' Please turn up (or down) your volume so that you are able to hear it clearly. As an attention check, you will be asked some simple questions about the music. </p>');
				hidebutton();
